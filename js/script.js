...
const moviesDatabase = [
  {
    ...
    region: "foreign",
    reviews: [
      { user: "Alex", rating: 10, comment: "Mind-blowing masterpiece!" },
      { user: "Sam", rating: 9, comment: "Incredible visuals and story." }
    ]
  },
  {
    id: 2,
    ...
    region: "foreign",
    reviews: [
      { user: "Jesse", rating: 10, comment: "Best TV show ever made." }
    ]
  },
  {
    id: 3,
